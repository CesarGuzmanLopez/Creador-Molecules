 ...
 */
package mx.com.uam.quimica.SustituyentesSmiles.ParchesCDK;
 ...
 * @cdk.githash
 */
public class AtomContainerR extends AbstractRenderer<IAtomContainer> implements IRenderer<IAtomContainer> {
     ...
     */
    public AtomContainerR(List<IGenerator<IAtomContainer>> generators, IFontManager fontManager) {
    ...
    public AtomContainerR(RendererModel rendererModel, List<IGenerator<IAtomContainer>> generators,
